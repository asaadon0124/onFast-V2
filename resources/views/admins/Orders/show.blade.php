...
@section('content')
    ...
    <section class="content">
        ...
        @livewire('admin.order.show', ['id' => $id])
        @livewire('admin.order-detailes.create')
        @livewire('admin.order-detailes.update')
        @livewire('admin.order-detailes.show')
        @livewire('admin.order-detailes.delete')
