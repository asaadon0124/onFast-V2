...
<script>
    ...
    {
        Livewire.on('ordersUpdateMS', function()
        {
            toastr.success('تم تحديث خط السير بنجاح', 'رسالة تحديث', { timeOut: 5000 });
        });


        Livewire.on('ordersCreateMS', function()
        {
            toastr.success('تم اضافة خط السير بنجاح', 'رسالة اضافة', { timeOut: 5000 });
        });


        Livewire.on('ordersErrorMS', function()
        {
