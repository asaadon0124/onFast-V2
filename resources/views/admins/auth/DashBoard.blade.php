...
@section('title1', 'الرئيسية')
@section('page_header_main', ' الرئيسية')
@section('page_header1', 'الرئيسية')
@section('page_header1_link', route('admin.dashboard'))
@section('page_header2', 'الرئيسية')
...
@section('content')
    ...
    <section class="content">
        @livewire('admin.dash-board.data')
